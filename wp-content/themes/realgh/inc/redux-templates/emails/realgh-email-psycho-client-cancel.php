...
Redux::set_section(
	$opt_name,
	array(
		'title'      => esc_html__( 'Therapist client cancelled>24 h', 'realgh' ),
		'id'         => 'therapist_client_cancel',

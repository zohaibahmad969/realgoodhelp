...
Redux::set_section(
	$opt_name,
	array(
		'title'      => esc_html__( 'Client cancelled no refund', 'realgh' ),
		'id'         => 'client_cancel_no_refund',

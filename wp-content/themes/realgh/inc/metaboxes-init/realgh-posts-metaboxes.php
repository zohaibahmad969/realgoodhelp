...
if (is_admin()){
	...
	*/
	...
	$cfg_mainscreen = array(
	 ...
	 'page_name'       => 'template-posts.php',  // if single = true. Name of page for which to output metaboxes
	...
	*/
	...
	$experts->addSelect(
		$prefix.'experts_spec',
		array_merge(array('' => 'Select specialisation'), $specialisations),
		array( 'name' => esc_html__('Specialisation', 'realgh') )
	);

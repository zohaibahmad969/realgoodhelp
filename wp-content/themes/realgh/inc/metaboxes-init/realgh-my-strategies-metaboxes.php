...
if (is_admin()){
  ...
  */
  ...
  $cfg_mainscreen = array(
    ...
    'page_name'       => 'template-my-strategies.php',  // if single = true. Name of page for which to output metaboxes
   ...
   */
   ...
   $mainscreen->addText(
    $prefix_za.'empty_goals_title', array( 'name' => esc_html__('No Goals title', 'realgh') )
   );
   $mainscreen->addText(
    $prefix_za.'empty_goals_text', array( 'name' => esc_html__('No goals text', 'realgh') )
   );
   //Text field
   $mainscreen->addText(
  ...
  // Empty----------------------------------------------------------
  $cfg_empty = array(
	 'id'              => $prefix_za.'empty',          // meta box id, unique per meta box
	 'title'           => esc_html__('No saved lessons content', 'realgh'),   // meta box title
	 'pages'           => array('page'),      // post types, accept custom post types as well, default is array('post'); optional
	 'single'          => true,      // Display metaboxes on a specific page (false if diplayed at all)
	 'page_name'       => 'template-my-strategies.php',  // if single = true. Name of page for which to output metaboxes
	 'context'         => 'normal',            // where the meta box appear: normal (default), advanced, side; optional
  ...
  /*
	* Initiate your meta box
  */
  $empty =  new AT_Meta_Box($cfg_empty);
  ...
  */
  //Text field
  $empty->addText(
	 $prefix_za.'empty_title', array( 'name' => esc_html__('No saved lessons title', 'realgh') )
  );
  //Text field
  $empty->addText(
	 $prefix_za.'empty_text', array( 'name' => esc_html__('No saved lessons text', 'realgh') )
  );
  //Text field
  $empty->addText(
	 $prefix_za.'empty_btn', array( 'name' => esc_html__('No saved lessons button text', 'realgh') )
  );

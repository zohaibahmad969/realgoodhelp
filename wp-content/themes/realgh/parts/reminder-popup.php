...
<div class="popup reminder__popup">
    <div class="popup__body popup__body--bg reminder-popup__body reminder-popup__body--bg">
                        ...
                        <div class="reminder__content">
                            ...
                            <form class="form reminder__form">
                                ...
                                <div class="tabs-container">
                                    <div class="tabs reminder__tabs">
                                        ...
                                        <input data-tab-item="telegram" type="radio" name="method" value="telegram"
                                            id="telegram-tab" class="tab" checked>
                                        <label for="telegram-tab"
                                            class="label tab-label reminder__tab-label subtitle fz-16">Telegram</label>
                            ...
                            <label for="push-tab" class="label tab-label reminder__tab-label subtitle fz-16">Push notifications</label> -->
                                    ...
                                    <div class="tabs__content">
                                        ...
                                        <div id="telegram" class="tab__item reminder__tab-item req-field active">
                                            <p class="text fz-14 fw-600">Send a message to our bot and paste the
                                                received id into the field below</p>
                                            <a href="https://t.me/real_good_help_bot" class="link text fz-14 c-main"
                                                target="blank">@real_good_help_bot</a>
                                            <input type="number" name="telegram_id" class="input input-text input-numb"
                                                placeholder="Enter the telegram's id"
                                                value="<?php echo $user_data->telegram_id; ?>">
                                        </div>

                                        <!-- <div id="push" class="tab__item reminder__tab-item req-field">
                                <p class="text fz-14 fw-600">Some description about push notifications and app installation</p>
                                <div class="form__row">
                                    ...
                                    <?php if (!$reminders): ?>
                                        <div class="reminder__form-row">
                                            ...
                                            <div class="form__cell req-field">
                                                ...
                                                <input type="date" name="date[]" class="input input-text"
                                            ...
                                            <div class="form__cell req-field">
                                                <div class="reminder_repeat">
                                                    ...
                                                    <input type="number" name="repeat[]" class="input input-text input-numb"
                                                        placeholder="days" min="0" max="99">
                                                </div>
                                            </div>
                                            <button type="button"
                                                class="button transp-button reminder__remove-button single">
                                        ...
                                        foreach ($reminders as $reminder):
                                            ...
                                            <div class="reminder__form-row">
                                                ...
                                                <button type="button"
                                                    class="button transp-button reminder__remove-button <?php echo count($reminders) == 1 ? 'single' : ''; ?>">
                                                    <i class="icon realgh-close c-main"></i>
                                                </button>
                                            </div>
                                            <?php

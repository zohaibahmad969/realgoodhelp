...
$categories = get_the_category(get_the_ID()); // Get an array of all categories that the post belongs to

if (!empty($categories)) {
    $category = $categories[0]; // Get the first category in the array

    $ancestors = get_ancestors($category->term_id, 'category');
    if (!empty($ancestors)) {
        $most_parent_category_id = end($ancestors); // Get the highest-level parent category from the array
        $most_parent_category = get_term($most_parent_category_id, 'category'); // Get the most parent category object
        $category = $most_parent_category->name;
    } else {
...
<div id="sc-exercies-wrap" class="wellbeing-category-page sc-exercies-wrap"
    ...
    <div class="sc-exerice-template">
        <div class="sc-exercise-box">
            <div class="sc-exercise-header">
                <h2 class="sc-exercise-header title text-center">
                    Hey, Friend!
                    <br>
                    Let's work on your <span class="col-blue sc-exercise-category">
                        <?php echo $category; ?>
                    </span>
                </h2>
                ...
                <div class="sc-exercise-layout-50-50">
                    <div class="sc-exercise-layout-50-50-col w-70">
                        <div class="sc-exercise-layout-30-70 m-b-15">
                            ...
                            <div>
                                <a href="#" class="sc-exercise-strategy text col-blue">
                        ...
                        <div class="sc-exercise-layout-30-70 m-b-15">
                            ...
                            <div>
                                <p class="sc-exercise-title text">
                                    <?php echo get_post_meta(get_the_ID(), 'wellbeing_exercise_text', true) ?>
                                </p>
                            </div>
                        </div>
                        <div class="sc-exercise-layout-30-70">
                            ...
                            <div>
                                <p class="sc-exercise-description text">
                                    <?php echo get_post_meta(get_the_ID(), 'wellbeing_exercise_description', true) ?>
                                </p>
                            </div>
                        </div>
                        <span style="display: none;" class="sc-ui-post-exerices-template-on-singlepost">
                            <?php echo get_post_meta(get_the_ID(), 'wellbeing_exercise_template', true); ?>
                        </span>
                    </div>
        ...
        <div class="sc-exercise-box sc-exercise-template" data-template="sc-et-situtaiondescription" id="sd_template">
            <h2 class="title col-blue fw-700">List</h2>
            <form class="sc-exercise-sd-form" method="GET" data-sdcount="1" data-postid='<?php echo get_the_ID(); ?>' data-posttitle='<?php echo get_the_title(get_the_ID()); ?>' data-postlink="<?php echo get_permalink(get_the_ID()) . '?show_exercise_screen=true' ?>">
                <div class="form__cell req-field m-b-10">
                    <input type="text" placeholder="Situation" class="input input-text input--req exercise_situation"
                        name="exercise_situation" required>
                </div>
                <div class="form__cell req-field m-b-10">
                    <input type="text" placeholder="Description"
                        class="input input-text input--req exercise_description" name="exercise_description" required>
                </div>
                <div class="form__bot">
        ...
        <div class="sc-exercise-box sc-exercise-template" data-template="sc-et-plan" id="plan_template">
            ...
            <form class="sc-exercise-plan-form" method="GET" data-sdcount="1" data-postid='<?php echo get_the_ID(); ?>' data-posttitle='<?php echo get_the_title(get_the_ID()); ?>' data-postlink='<?php echo get_permalink(get_the_ID()) . '?show_exercise_screen=true' ?>'>
        ...
        <div class="sc-exercise-box sc-exercise-template" data-template="sc-et-journal" id="journal_template">
            ...
            <form class="sc-exercise-journal-form" method="GET" data-sdcount="1" data-postid='<?php echo get_the_ID(); ?>' data-posttitle='<?php echo get_the_title(get_the_ID()); ?>' data-postlink='<?php echo get_permalink(get_the_ID()) . '?show_exercise_screen=true' ?>'>
                <div class="form__cell req-field m-b-10">
        ...
        <div class="sc-exercise-box sc-exercise-template" data-template="sc-et-situtaionreflection" id="sr_template">
            <h2 class="title col-blue fw-700 m-b-20">Situations and Reflections</h2>
            <form class="sc-exercise-sr-form" method="GET" data-sdcount="1" data-postid='<?php echo get_the_ID(); ?>' data-posttitle='<?php echo get_the_title(get_the_ID()); ?>' data-postlink='<?php echo get_permalink(get_the_ID()) . '?show_exercise_screen=true' ?>'>
                <div class="form__cell req-field m-b-10">
                    <input type="text" placeholder="Situation" class="input input-text input--req exercise_t4_situation"
                        name="exercise_t4__situation" required>
                </div>
                <div class="form__cell req-field m-b-10">
                    <input type="text" placeholder="Reflection"
                        class="input input-text input--req exercise_t4_reflection" name="exercise_reflection" required>
                </div>
                <div class="form__bot">
                    <button type="submit" class="button button--big blue-button">
                        <span class="button-text">
